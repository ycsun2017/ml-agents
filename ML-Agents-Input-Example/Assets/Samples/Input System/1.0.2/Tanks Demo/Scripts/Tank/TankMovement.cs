...
public class TankMovement : MonoBehaviour, IIntputActionAssetProvider
{
    ...
    TanksInputActions m_InputActions;
    ...
    private void Awake()
    {
        ...
        m_InputActions.Player.Brake.performed += BrakeOnperformed;
        m_InputActions.Player.Gas.performed += GasOnperformed;
        m_InputActions.Player.Turret.performed += TurretOnperformed;
