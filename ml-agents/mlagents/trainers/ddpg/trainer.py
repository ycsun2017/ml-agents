...
from mlagents.trainers.ddpg.optimizer_torch import TorchDDPGOptimizer
...
class DDPGTrainer(RLTrainer):
    """
    The DDPGTrainer is an implementation of the DDPG algorithm, with support
    ...
    def __init__(
        ...
        self.optimizer: TorchDDPGOptimizer = None  # type: ignore
        ...
        print("using DDPG transfer trainer")
    ...
    def _update_policy(self) -> bool:
        ...
        """
        policy_was_updated = self._update_ddpg_policy()
    ...
    def _update_ddpg_policy(self) -> bool:
        """
        ...
        while (
            ...
            logger.debug(f"Updating DDPG policy at step {self.step}")
    ...
    def create_ddpg_optimizer(self) -> TorchDDPGOptimizer:
        return TorchDDPGOptimizer(  # type: ignore
    ...
    def add_policy(
        ...
        self.optimizer = self.create_ddpg_optimizer()
