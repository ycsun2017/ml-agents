...
from mlagents.trainers.dqn.optimizer_torch import TorchDQNOptimizer
...
class DQNTrainer(RLTrainer):
    ...
    def __init__(
        ...
        self.optimizer: TorchDQNOptimizer = None  # type: ignore
    ...
    def _update_policy(self) -> bool:
        ...
        """
        policy_was_updated = self._update_dqn_policy()
    ...
    def _update_dqn_policy(self) -> bool:
        """
        ...
        while (
            ...
            logger.debug(f"Updating DQN policy at step {self.step}")
            ...
            if self.update_buffer.num_experiences >= self.hyperparameters.batch_size:
                ...
                if not self.hyperparameters.transfer_target:
                    for i in range(5):
                        ...
                        self.optimizer.update_model(sampled_minibatch, n_sequences)
    ...
    def create_dqn_optimizer(self) -> TorchDQNOptimizer:
        return TorchDQNOptimizer(  # type: ignore
            cast(DQNPolicy, self.policy), self.trainer_settings  # type: ignore
        )  # type: ignore
    ...
    def add_policy(
        ...
        self.optimizer = self.create_dqn_optimizer()
    ...
    def save_model_transfer(self) -> None:
        """
