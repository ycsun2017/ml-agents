...
from mlagents.trainers.ppo_transfer.optimizer_torch import TorchPPOTransferOptimizer
...
class PPOTransferTrainer(RLTrainer):
    ...
    def __init__(
        ...
        self.model_buffer: AgentBuffer = AgentBuffer()

        print("using PPO transfer trainer")
    ...
    def create_ppo_optimizer(self) -> TorchPPOTransferOptimizer:
        return TorchPPOTransferOptimizer(  # type: ignore
