...
class TorchSACTransferOptimizer(TorchOptimizer):
    ...
    def __init__(self, policy: TorchPolicy, trainer_params: TrainerSettings):
        ...
        self.q_network = TorchSACTransferOptimizer.PolicyValueNetwork(
            self.stream_names,
            self.policy.behavior_spec.observation_specs,
        ...
        self._log_ent_coef = TorchSACTransferOptimizer.LogEntCoef(
        ...
        self.target_entropy = TorchSACTransferOptimizer.TargetEntropy(
